...
if (isset($_GET['t'])) {
    //Topic id opgegeven -> Topic weergeven
    
    if (!$member->getPermissions()->canViewTopic()) {
        //Gebruiker heeft geen rechten om topics te bekijken
        $smarty->assign('errors',array("Je hebt niet genoeg rechten om topics te bekijken (niet ingelogd?)"));
...
elseif (isset($_GET['f'])) {
    //Forum id opgegeven -> Forum weergeven
    
    if (!$member->getPermissions()->canViewForum()) {
        //Gebruiker heeft geen rechten om forums te bekijken
        $smarty->assign('errors',array("Je hebt niet genoeg rechten om forums te bekijken (niet ingelogd?)"));
        $smarty->display('error.tpl');
    }
    else {
...
elseif (isset($_GET['c'])) {
    //Categorie id opgegeven -> Categorie weergeven
    
    if (!$member->getPermissions()->canViewBoard()) {
        //Gebruiker heeft geen rechten om het board te bekijken
        $smarty->assign('errors',array("Je hebt niet genoeg rechten om het board te bekijken (niet ingelogd?)"));
        $smarty->display('error.tpl');
    }
    else {
        $category = new Category($db);
